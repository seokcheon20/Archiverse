...
export async function getSatoriFonts(headerFont: FontSpecification, bodyFont: FontSpecification) {
  ...
  const headerFontPath = joinSegments(QUARTZ, "static", "fonts", "AtkinsonHyperlegibleMono-Regular.ttf")
  const bodyFontPath = joinSegments(QUARTZ, "static", "fonts", "Inter-Regular.ttf")
  const fonts: SatoriOptions["fonts"] = [
    // // Header
    {
      name: "Atkinson Mono",
      data: await fs.readFile(path.resolve(headerFontPath)),
      weight: 400,
      style: "normal" as const,
    },
    // Footer
    {
      name: "Inter",
      data: await fs.readFile(path.resolve(bodyFontPath))
        // .then((woff2) => decompress(woff2))
        // .then((woff2_dec) => {
        // // util function 
        // const nodeBufferToArrayBuffer = function(buffer: Uint8Array | Buffer) {
        ...
        //   return ab
        // }
        // let font = opentype.parse(nodeBufferToArrayBuffer(woff2_dec))
        // return font.toArrayBuffer()
        // return opentype.parse(nodeBufferToArrayBuffer(woff2_dec)).toArrayBuffer()
        //})
      ,
      weight: 400,
      style: "normal" as const,
...
export const customImageStructure: SocialImageOptions["imageStructure"] = ({
  cfg,
  userOpts,
  title,
  description,
